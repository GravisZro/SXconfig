...
public:
  ...
  bool configUpdated(const posix::fd_t socket, const std::list<std::string>& name) const noexcept;
...
inline bool ExecutorConfigServer::configUpdated(const posix::fd_t socket, const std::list<std::string>& name) const noexcept
